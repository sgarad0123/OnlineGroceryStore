...
namespace GroceryStore.Controllers
{
    public class Product1Controller : Controller
    {
        ...
        public ActionResult AddToCart(int id)
        {
            ...
            {
                TempData["returnURL"] = "/"; // Set a default return URL if it's not already set
            }
        ...
        public ActionResult WishList(int id)
        {
            ...
            db.SaveChanges();
            AddRecentViewProduct(id);
            int wishlistItemCount = db.Wishlists.Where(x => x.CustomerID == TempShpData.UserID).Count();
            ViewBag.WlItemsNo = wishlistItemCount;
